 ...
 */
export type ReleasePleaseManifestConfigSchema =
  ReleasePleaseManifestConfigSchema1 & ReleasePleaseManifestConfigSchema2;
export type ReleasePleaseManifestConfigSchema1 = ReleaserConfigOptions & {
  /**
   ...
   */
  packages: {
    [k: string]: ReleaserConfigOptions;
  };
  /**
  ...
  plugins?: (
    ...
    | {
         ...
         * The name of the plugin.
         */
        type?: "cargo-workspace" | "maven-workspace" | "node-workspace";
        /**
...
export interface ReleasePleaseManifestConfigSchema2 {
  $schema?: unknown;
  packages?: unknown;
